...
public class FaviconIconSetter : MonoBehaviour
{
    ...
    async void Start()
    {
        ...
        void MainWebView_UrlChanged(object sender, UrlChangedEventArgs eventArgs) {
            ...
            if (File.Exists(Application.persistentDataPath + "/saves/favicons/"+ baseURL + ".png")){
        ...
        IEnumerator LoadImage(string ImageUrl){
            ...
            if (www.error == null){
                ...
                File.WriteAllBytes(Application.persistentDataPath + "/saves/favicons/"+ baseURL + ".png", dataByte);
