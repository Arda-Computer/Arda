...
public class WindowState : MonoBehaviour, ISaveable
{
    float xPosition;
    float yPosition;
    float zPosition;
    ...
    public object SaveState()
    {
        ...
        // if(this.gameObject != null){
            ...
            // if(this.gameObject.GetComponentInChildren<CanvasWebViewPrefab>().WebView. == "")
            // {
            ...
            //         focusedWindowUrl = this.gameObject.GetComponentInChildren<CanvasWebViewPrefab>().InitialUrl
            ...
            // }else{ //if the room was opened, then save normally - by using the name of the focusedWindow GO
                ...
                return new WindowData()
                {
                    ...
                    focusedWindowUrl = this.gameObject.name
        ...
        //             // focusedWindowUrl = this.gameObject.GetComponentInChildren<CanvasWebViewPrefab>().WebView.Url
    ...
    public void LoadState(object state)
    {
        ...
        this.gameObject.GetComponentInChildren<CanvasWebViewPrefab>().InitialUrl = data.focusedWindowUrl;
    }
